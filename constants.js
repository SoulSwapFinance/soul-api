...
module.exports = {
  API_BASE_URL, SUMMONER_ADDRESS,
  _1E18, LUX, SOUL, WLUM, WFTM, LUM, DAI,
  LUXOR_TREASURY_ADDRESS, SOUL_DAO, PRICE_FETCHER_ADDRESS,
  LUX, DAI, LUM, WLUM, WFTM, FTM_DAI_LP, FTM_WLUM_LP, DAI_LUX_LP,
